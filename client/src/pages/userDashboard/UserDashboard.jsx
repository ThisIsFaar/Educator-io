    ...
    <div className="flex flex-no-wrap">
                ...
                >
                  <div className="flex justify-center items-center">
                    <FontAwesomeIcon
                      ...
                      // size="2x"
                    />
                    <span className="text-sm uppercase text-center font-semibold ml-2">
                      {item.title}
                    </span>
                  </div>
                </li>
      ...
      <div
        className={classNames(
          "w-64 h-screen z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out",
          {
      ...
      >
        <div
          className="h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br text-secondary justify-center cursor-pointer"
          id="mobile-toggler"
