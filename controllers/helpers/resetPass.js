module.exports  = resetEmail = (verurl) => {              
                                      ...
                                      <tr>
                                        ...
                                        >
                                          <img
                                            align="center"
                                            border="0"
                                            src="https://examedai.sirv.com/Images/sample_logo.png"
                                            alt="Image"
                                            title="Image"
                                            style="
                                              outline: none;
                                      ...
                                      <p style="font-size: 14px; line-height: 160%">
                                        <span
                                          style="
                                            ...
                                            line-height: 28.8px;
                                          "
                                          >You have requested for a reset password link, You're almost ready to get set with the new one.
                                          Please click on the button below activation link to verify
                                          and update your account and enjoy exclusive
                                      ...
                                      <p style="font-size: 14px; line-height: 180%">
                                        <span
                                          style="
                                            ...
                                            line-height: 28.8px;
                                          "
                                          >Copyrights &copy; Educator.io All Rights
                                          Reserved</span
                                        >
                                      </p>
                                    </div>
